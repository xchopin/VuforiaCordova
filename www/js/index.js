var app = {
    ...
    vuforiaMatch: function(data) {
        ...
        if(data.status.imageFound) {
            ...
            if(app.simpleOptions) {
                if (data.result.imageName == "stones") {
                  document.getElementById('stones-video').play();
                }else{
                  alert("You just scanned the "+ data.result.imageName + " image");
                }
        ...
        // Are we manually closing?
            ...
            alert("Hey you just closed the AR :(");
